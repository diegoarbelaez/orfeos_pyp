            ...
            <div class="card-body">
                <div class="card-body">
                    ...
                    <table class="table table-striped table-hover">
                        ...
                        <?php
                        $sentencia = "SELECT * from $nombre_tabla WHERE 'FECHA RADICADO' > '2021-09-01 00:00:00' and categoria =".$_GET['categoria']." order by 'FECHA RADICADO' DESC";
                        ...
                        ?>
                            <script type="text/javascript">
                                window.location = "listado_orfeos_admin.php?pagina=1&categoria=<?php echo $_GET['categoria'] ?>";
                            </script>
                        <?php
                        } else {
                            $iniciar = ($_GET['pagina'] - 1) * $elementosxpagina;
                            $sql = mysqli_query($conexion, "SELECT * from $nombre_tabla WHERE 'FECHA RADICADO' > '2021-09-01 00:00:00' and categoria =".$_GET['categoria']." order by 'FECHA RADICADO' DESC LIMIT " . $iniciar . "," . $elementosxpagina);
                    ...
                    <div class="card-footer clearfix">
                        <ul class="pagination pagination-sm m-0 float-right">
                            <li class="page-item <?php echo $_GET['pagina'] <= 1 ? 'disabled' : '' ?>">
                                <a class="page-link" href="listado_orfeos_filtro.php?pagina=<?php echo $_GET['pagina'] - 1 ?>&categoria=<?php echo $_GET['categoria'] ?>">
                                    Anterior
                                </a>
                            </li>
                            <?php for ($i = 0; $i < $paginas; $i++) : ?>
                                <li class="page-item <?php echo $_GET['pagina'] == $i + 1 ? 'active' : '' ?>"><a class="page-link" href="listado_orfeos_filtro.php?pagina=<?php echo $i + 1  ?>&categoria=<?php echo $_GET['categoria'] ?>"><?php echo $i + 1  ?></a></li>
                            <?php endfor ?>
