...
<body class="nav-fixed">
    <main>
        ...
        <!-- Main page content-->
        <form action="ver_documentos2.php" method="POST">
            <div class="card mb-4">
                <div class="card-body">
                    <div class="card-body">
                        ...
                        <div class="position-relative form-group row">
                            <div class="col-md-3">
                                <label class="">Digite la Cédula</label>
                                <input name="cedula" id="telefono" placeholder="" type="number" class="form-control">
                            </div>
                        </div>
                        <button type="submit" class="btn btn-primary">CONSULTAR</button>
                        <br>
                        <br>
                        <a href="index2.php" class="btn btn-success" target="new"> Click aquí para ver el listado completo</a>
                    </div>
                </div>
