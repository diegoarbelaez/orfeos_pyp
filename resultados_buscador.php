    ...
    <main>
                    ...
                    <div class="row align-items-center justify-content-between">
                        ...
                        <!-- <div class="col-auto mt-4">
                            <div class="form-group">
                                <form action="resultados_buscador.php" method="POST">
        ...
        <div class="text-center mb-5">
            ...
            <div class="display-4"><?php
                                    $sentencia_cargados = "select count(*) as total_casos from $nombre_tabla WHERE 'FECHA RADICADO' > '2021-09-01 00:00:00' and responsable='" . $_SESSION["user"] . "'";
            ...
            <div class="card-body">
                <div class="card-body">
                    <form action="resultados_buscador.php" method="POST">
                        <div>
                            <div class="form-group">
                                ...
                                <input class="form-control" type="text" name="usuario" placeholder="# Radicado" /><br>
                    ...
                    <table class="table table-striped table-hover">
                        ...
                        <?php
                        $sentencia_listado = "SELECT * from `$nombre_tabla` WHERE `FECHA` > '2021-09-01 00:00:00'  and responsable='" . $_SESSION["user"] . "' and `NUMERO RADICADO` like '".$radicado_buscar."' order by 'FECHA RADICADO' DESC";
                        //$sentencia_listado = "SELECT * from `OrfeosFebrero` WHERE `FECHA RADICADO` > '2021-09-01 00:00:00' and responsable='diegoarbelaez.co@gmail.com' and `NUMERO RADICADO` like '202242300357562' order by 'FECHA RADICADO' DESC";
                        //echo $sentencia_listado;
                        $sql = mysqli_query($conexion, $sentencia_listado);
