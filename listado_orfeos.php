...
<body class="nav-fixed">
    <main>
                ...
                <div class="page-header-content pt-4">
                    <div class="row align-items-center justify-content-between">
                        <div class="col-auto mt-4">
                            ...
                            <div class="page-header-subtitle"><a href="index.php" class="btn btn-success">INICIO</a> </div>
        ...
        <div class="card mb-12">
            <div class="card-body">
                <div class="card-body">
                    <form action="resultados_buscador.php" method="GET">
                        <div>
                            <div class="form-group">
                    ...
                    <table class="table table-striped table-hover">
                        ...
                        <?php
                        $sentencia_lista = "SELECT * from $nombre_tabla WHERE 'FECHA RADICADO' > '2021-09-01 00:00:00'  and responsable='" . $_SESSION["user"] . "' order by categoria ASC";
                        $sql = mysqli_query($conexion, $sentencia_lista);
                        ...
                        <?php
                            ...
                            echo $sentencia_lista;
                            $sql = mysqli_query($conexion, "SELECT * from $nombre_tabla WHERE 'FECHA RADICADO' > '2021-09-01 00:00:00'  and responsable='" . $_SESSION["user"] . "' order by categoria ASC LIMIT " . $iniciar . "," . $elementosxpagina);
                            while ($row = mysqli_fetch_assoc($sql)) {
                                ...
                                <td>' . "<a href='generar_respuesta_masiva.php?id=" . $row['id'] . "' target='_blank'>Generar PDF</a>" . '</td>';
