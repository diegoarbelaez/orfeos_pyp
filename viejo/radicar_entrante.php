            ...
            <div class="container mt-n10">
                <div class="row">
                    <div class="col-lg-9">
                        ...
                        <div id="default">
                            <div class="card mb-4">
                                <div class="card-header">Por favor diligencia La información de quien radica la PQRSD</div>
                                <div class="card-body">
                                    <!-- Component Preview-->
                                        ...
                                        <div class="sbp-preview-content">
                                                ...
                                                <tr>
                                                    <td width="50%">
                                                        <div class="form-group">
                                                            <label for="exampleFormControlInput1">Nombre de quien radica</label>
                                                            <input name="nombre_remitente" class="form-control" id="exampleFormControlInput1" type="text" required>
                                                        </div>
                                                    </td>
                                                    <td>
                                                        <div class="form-group">
                                                            <label for="exampleFormControlInput1">Cedula o NIT de Quien radica</label>
                                                            <input name="cedula_remitente" class="form-control" id="exampleFormControlInput1" type="text">
                                                        </div>
                                                    </td>
                                                    <td>
                                                        <div class="form-group">
                                                            <label for="exampleFormControlInput1">Empresa o Entidad</label>
                                                            <input name="entidad_remitente" class="form-control" id="exampleFormControlInput1" type="text">
                                                        </div>
                                                    </td>
                                                </tr>
                                            </table>
                                            <table>
                                                <tr>
                                                    ...
                                                    <td width="25%">
                                                        <div class="form-group">
                                                            <label for="exampleFormControlInput1">Dirección de quien radíca</label>
                                                            <input name="direccion_remitente" class="form-control" id="exampleFormControlInput1" type="text">
                                                        </div>
                                                    </td>
                                                    <td>
                                                        <div class="form-group">
                                                            <label for="exampleFormControlInput1">Teléfono de Quien Radica</label>
                                                            <input name="telefono_remitente" class="form-control" id="exampleFormControlInput1" type="text" required>
                                                        </div>
                                                    </td>
                                                </tr>
                                            </table>
