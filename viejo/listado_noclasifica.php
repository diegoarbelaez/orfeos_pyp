    ...
    <main>
        ...
        <div class="text-center mb-5">
            ...
            <div class="display-4"><?php
                                    ...
                                    $sentencia_cargados = "select count(*) as total_cargados from registro_micasa where clasificacion = 'No Clasifica'";
            ...
            <div class="card-body">
                <div class="card-body">
                    ...
                    <table class="table table-striped table-hover" id="dataTable" width="100%" cellspacing="0">
                        ...
                        <?php
                        $sentencia1 = "SELECT * from registro_micasa where clasificacion = 'No Clasifica'";
